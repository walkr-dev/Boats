...
public class Vehicle : MonoBehaviour{
	...
	void Update(){
		...
		if(Input.GetKeyUp(accelerate)) { smoke.Stop(); }
		...
		smokeEmission.enabled = true; //onGround && (sphere.velocity.magnitude > (acceleration / 4) && (Vector3.Angle(sphere.velocity, vehicleModel.forward) > 30.0f) || alwaysSmoke);
